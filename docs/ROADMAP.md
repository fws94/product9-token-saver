...
| --- | --- | --- | --- |
| [T01 / #1](https://github.com/fws94/product9-token-saver/issues/1) | Installable plugin and helper result contract | None | P0 |
| [T02 / #2](https://github.com/fws94/product9-token-saver/issues/2) | Deterministic command output compaction | T01 | P0 |
| [T03 / #3](https://github.com/fws94/product9-token-saver/issues/3) | Existing test, build and lint execution | T01, T02 | P0 |
| [T04 / #4](https://github.com/fws94/product9-token-saver/issues/4) | Bounded repository lookup | T01 | P0 |
| [T05 / #5](https://github.com/fws94/product9-token-saver/issues/5) | Batch status; GitHub first | T01 | P0; additional providers P1 |
| [T06 / #6](https://github.com/fws94/product9-token-saver/issues/6) | Submission delegation and continuation | T01 | P0 |
| [T07 / #7](https://github.com/fws94/product9-token-saver/issues/7) | Explicit issue administration | T01, T06 handoff contract | P0 for verified providers |
| [T08 / #8](https://github.com/fws94/product9-token-saver/issues/8) | Token measurement and local device reports | T01 | P0 |
| [T09 / #9](https://github.com/fws94/product9-token-saver/issues/9) | Runtime integration checks and first release | T02–T08 | P0 |
| [T10 / #10](https://github.com/fws94/product9-token-saver/issues/10) | Optional RTK integration after measurement | T02, T08, T09 | P1; optional |
