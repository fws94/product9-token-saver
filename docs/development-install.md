...
This is a metadata-only development plugin, not a released collection of runtime
skills. Installing it currently adds no skills, MCP servers, hooks or connectors.
...
Copy updated public helper files and the manifest to the same installed source,
...
version `0.1.0-dev.1`, installed and enabled it, then removed the installation and
