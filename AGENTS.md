...
Read README.md and CONTRIBUTING.md before changing this project. The compact-output helper and development plugin are implemented; other runtime helpers remain planned. Do not describe an issue or a design document as a working feature.
